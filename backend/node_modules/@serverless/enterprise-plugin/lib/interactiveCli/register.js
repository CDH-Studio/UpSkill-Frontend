...
/*#__PURE__*/
function () {
  var _ref4 = _asyncToGenerator(function* (email, password, userName, tenantName) {
    try {
      return yield register(email, password, userName, tenantName, tenantName);
    } catch (error) {
      const errorData = (() => {
        try {
...
/*#__PURE__*/
function () {
  var _ref5 = _asyncToGenerator(function* (inquirer, email = null) {
    ...
    try {
      return yield sdkSignUp(email, password, userName, tenantName);
    } catch (error) {
      if (error.sdkMessage) {
...
module.exports = {
  ...
  run(serverless) {
    return _asyncToGenerator(function* () {
      ...
      const _ref6 = yield signUp(inquirer),
            ownerUserName = _ref6.ownerUserName,
            tenantName = _ref6.tenantName,
            ownerAccessKey = _ref6.ownerAccessKey,
            ownerAuth0Id = _ref6.ownerAuth0Id;
      ...
      yield writeTenantAndApp(serverless, tenantName, appName);
      return undefined;
    })();
  }
